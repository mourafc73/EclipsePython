...
class analysedTextcls(object):
    ...
    # Constructor - Takes argument 'text',makes it lower case and removes
    # all punctuation. Assume only the following punctuation is used -
    # period (.), exclamation mark (!), comma (,) and question mark (?).
    # Store the argument in "fmtText"
    # freqAll - returns a dictionary of all unique words in the text along with
